...
# 导入拆分出的处理器模块
from app.services.xianyu.xianyu_message_handler import MessageHandler
from app.services.xianyu.xianyu_delivery_handler import DeliveryHandler
from app.services.xianyu.xianyu_notification_handler import NotificationHandler
from app.services.xianyu.token_manager import TokenManager
from app.services.xianyu.item_manager import ItemManager
from app.services.xianyu.image_message_manager import ImageMessageManager
...
class XianyuLive:
    ...
    async def _handle_image_keyword(self, keyword: str, image_url: str, send_user_name: str, send_user_id: str, send_message: str) -> str:
        """处理图片类型关键词"""
        from app.core.handlers.image_handler import ImageHandler
